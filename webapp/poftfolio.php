    ...
    <!-- Intro Section -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div>
                        <img src="images/superlow.jpg" class="img-responsive img-rounded">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div>
                        <img src="images/spaceshit.jpg" class="img-responsive img-rounded" alt="">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div>
                        <img src="images/player.jpg" class="img-responsive img-rounded" alt="">
                    </div>
                </div>				
				                <div class="col-lg-12 text-center">
			...
			<div class="row">
                <div class="col-sm-4">
                    <div>
                        <img src="images/lloyd3d.jpg" class="img-responsive img-rounded" alt="">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div>
