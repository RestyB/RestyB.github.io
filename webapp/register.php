...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Project Poftfolio</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
					...
					<li>
                        <a link href="poftfolio.php">Poftfolio</a>
                    </li>
					<li>
    ...
    <!-- Intro Section -->
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-left"><br><br><br><br><br><br><br>
                    <h2 class="section-heading">Register</h2><br><br><br><br>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-13">
